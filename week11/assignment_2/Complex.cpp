...
Number *Complex::add(Number * num) {
    ...
    if (num->types() == INTEGER) {
        ...
        double _first = other->val() + this->real();
        double _second = this->imag();
		delete(this);
        delete(other);
        return new Complex(_first, _second);
        ...
        double _first = other->val().first + this->real();
        double _second = other->val().second + this->imag();
        delete(this);
        delete(other);
        return new Complex(_first, _second);
    } else {
...
Number *Complex::sub(Number * num) {
    ...
    if(num->types() == INTEGER){
        Integer* other = dynamic_cast<Integer*>(num);
        double _first = this->real() - other->val();
		double _second = this->imag() * -1;
        delete(this);
        delete(other);
        return new Complex(_first, _second);
    }
        ...
        Complex* other = dynamic_cast<Complex*>(num);
        double _first = this->real() - other->val().first;
        double _second = this->imag() - other->val().second;
        delete(this);
        delete(other);
        return new Complex(_first, _second);
    }
...
Number *Complex::mul(Number * num) {
    ...
    if(num->types() == INTEGER){
        Integer * other = dynamic_cast<Integer*>(num);
        double _first = other->val() * this->real();
		double _second = other->val() * this->imag();
        delete(this);
        delete(other);
        return new Complex(_first, _second);
    }
		...
		double a = this->real();
		double b = this->imag();
		double c = other->val().first;
		double d = other->val().second;
        double _first = (a*c - b*d);
        double _second = (a*d + b*c);
        delete(this);
        delete(other);
        return new Complex(_first, _second);
    }
...
Number *Complex::div(Number * num) {
    ...
    if(num->types() == INTEGER){
        Integer * other = dynamic_cast<Integer*>(num);
        double _first = this->real() / other->val();
        double _second = this->imag() / other->val();
		delete(this);
        delete(other);
        return new Complex(_first, _second);
    }
		...
		double c = other->val().first;
		double d = other->val().second;
        double _first = (a*c + b*d) / (c*c + d*d);
        double _second = (b*c - a*d) / (c*c + d*d);
        delete(this);
        delete(other);
        return new Complex(_first, _second);
    }
