...
Integer::Integer(const std::string& str) {
     ...
     */
	 this->set_val(this->parse_string(str));
}
...
Number *Integer::sub(Number * num) {
	...
	if(num->types() == INTEGER){
		...
		Complex* other = dynamic_cast<Complex*>(num);
		double _first = value - other->val().first;
		double _second = other->val().second;
		delete(this);
		delete(other);
		return new Complex(_first, _second);
...
Number *Integer::mul(Number * num) {
	...
	if(num->types() == INTEGER){
		...
		Complex* other = dynamic_cast<Complex*>(num);
		double _first = other->val().first * value;
		double _second = other->val().second * value;
		delete(this);
		delete(other);
		return new Complex(_first, _second);
	}
...
Number *Integer::div(Number * num) {
	...
	if(num->types() == INTEGER){
		...
		Complex* other = dynamic_cast<Complex*>(num);
		double _first = value / other->val().first;
		double _second = value / other->val().second;
		delete(this);
		delete(other);
		return new Complex(_first, _second);
	}
